...
--Goal:Create non-clustered index on the ProductName column in the Products table and compare query execution time before and after index creation.
SELECT * FROM Products WHERE ProductName = 'Laptop';
CREATE NONCLUSTERED INDEX idx_ProductName ON Products(ProductName);
SELECT * FROM Products WHERE ProductName = 'Laptop';

-- Exercise 2: Creating a Clustered Index
-- Goal:Create clustered index on the OrderDate column in Orders table and compare query execution time before and after index creation.
...
-- Goal:Create composite index on CustomerID and OrderDate columns in Orders table and compare query execution time before and after index creation.0
